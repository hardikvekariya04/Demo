...
class Exam(models.Model):
    ...
    # This function get all the participant of the exam
    def getParticipant(self):
        participant = len(AttemptedExam.objects.filter(exam_id=self.id))
        return participant

    # This function get all the submission of the exam
    ...
    # Check the function exam is started or not
    def isStarted(self):
    ...
    # Check the function exam is running or not
    def isRunning(self):
        timezone = self.exam_date_time.tzinfo
    ...
    # Check the fucntion which exam is upcoming
    def isUpcoming(self):
        timezone = self.exam_date_time.tzinfo
        mins = self.exam_duration
        mins_added = datetime.timedelta(minutes=mins)
...
# This is a attempted exam model
